...
<div>
		<h2>방명록 : 내용화면</h2>
		<hr>
		<p>[ <a href="${pageContext.request.contextPath}/Mycontroller?cmd=list">게시물 목록으로</a> ]</p>
		<form method="post" >
			<table>
				<tbody>
					...
					<c:choose>
						...
						<td>
							<a href="view/download.jsp?path=upload&f_name=${vo.f_name}"><img
							src="upload/${vo.f_name }" style="width: 80px"></a><br>
							${vo.f_name}
						</td>
						</c:when>
						<c:otherwise>
